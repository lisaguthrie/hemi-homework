...
Converts scanned homework worksheets into accessible single-page web apps, customized for a specific child's barriers and needs.
...
1. `python runners/cli.py --worksheet <path> --child <name> [--subject <subject>]`
...
1. The **framework files** (`framework/`) contain generalizable knowledge: design system, interaction patterns, build constraints, worksheet type taxonomy
...
│   ├── BUILD_CONSTRAINTS.md      # output rules and build behavior
